...
/** 발견으로 치기까지 비춰야 하는 시간(초).

    0.45 로 시작했다가 "그냥 탐색 중인데 자꾸 발견된다"는 소리를 들었다.
    스쳐 지나가는 것과 들여다보는 것을 가르려면 이 정도는 걸려야 한다.
    자를 대고 재 보면 사람이 "아, 여기 뭔가 있네" 하고 멈추는 데만 0.5초쯤 쓴다. */
export const FIND_SECONDS = 1.1
